/**
 * The Data module provides functions for interacting with the data object
 * passed to snabbdom's h function.
 */
...
/**
 * Return a new, empty Snabbdom data object.
 ...
 *
 * Pass an array of strings representing the path to the property to be set,
 * followed by the property value. Intermediate objects will be created if they
 * don't already exist.
 *
